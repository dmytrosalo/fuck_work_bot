...
func generateJoke(apiKey, userName string) string {
	...
	prompt := fmt.Sprintf(`Згенеруй один агресивний жарт з підколкою українською мовою на тему: %s.
Жарт адресований розробнику на ім'я %s.

Правила:
- Жарт має бути їдким, саркастичним і з підколкою
- Тон: як друг який підколює друга, жорстко але смішно
- Максимум 3-4 речення
- Можна використовувати мат-лайт (блін, чорт, фігня, задовбав, дістав)
- Можна тикати на слабкості: лінь, тупість, жадібність, невезіння
- Формат: підколка, токсичний комплімент, або "правда яку ніхто не хоче чути"
- Не згадуй війну чи політику
- Тільки текст, без заголовків, зірочок та форматування`, topic, userName)
