...
func (b *Bot) muteCheck(next func(tele.Context) error) func(tele.Context) error {
	return func(c tele.Context) error {
		...
		if b.db.IsMuted(userID) {
			return c.Reply("🔇 Ти замучений. Напиши /unmute щоб розблокувати всі команди.")
		}
		return next(c)
	}
}
...
func (b *Bot) Register(bot *tele.Bot) {
	// These work even when muted
	bot.Handle("/start", b.handleStart)
	bot.Handle("/help", b.handleHelp)
	bot.Handle("/mute", b.handleMute)
	bot.Handle("/unmute", b.handleUnmute)

	// Everything else requires unmuted
	bot.Handle("/check", b.muteCheck(b.handleCheck))
	bot.Handle("/stats", b.muteCheck(b.handleStats))
	bot.Handle("/roast", b.muteCheck(b.handleRoast))
	bot.Handle("/compliment", b.muteCheck(b.handleCompliment))
	bot.Handle("/quote", b.muteCheck(b.handleQuote))
	bot.Handle("/pack", b.muteCheck(b.handlePack))
	bot.Handle("/collection", b.muteCheck(b.handleCollection))
	bot.Handle("/pokemon", b.muteCheck(b.handlePokemon))
	bot.Handle("/horoscope", b.muteCheck(b.handleHoroscope))
	bot.Handle("/8ball", b.muteCheck(b.handleEightBall))
	bot.Handle("/slots", b.muteCheck(b.handleSlots))
	bot.Handle("/slot", b.muteCheck(b.handleSlots))
	bot.Handle("/balance", b.muteCheck(b.handleBalance))
	bot.Handle("/bal", b.muteCheck(b.handleBalance))
	bot.Handle("/daily", b.muteCheck(b.handleDaily))
	bot.Handle("/top", b.muteCheck(b.handleTop))
	bot.Handle("/dog", b.muteCheck(b.handleDog))
	bot.Handle("/cat", b.muteCheck(b.handleCat))
	bot.Handle("/quiz", b.muteCheck(b.handleQuiz))
	bot.Handle("/duel", b.muteCheck(b.handleDuel))
	bot.Handle("/accept", b.muteCheck(b.handleAccept))
	bot.Handle(&tele.Btn{Unique: "duel_pick"}, b.handleDuelPick)
	bot.Handle("/steal", b.muteCheck(b.handleSteal))
	bot.Handle("/gift", b.muteCheck(b.handleGift))
	bot.Handle("/burn", b.muteCheck(b.handleBurn))
	bot.Handle("/sacrifice", b.muteCheck(b.handleSacrifice))
	bot.Handle("/showcase", b.muteCheck(b.handleShowcase))
	bot.Handle("/gacha", b.muteCheck(b.handleGacha))
	bot.Handle("/auction", b.muteCheck(b.handleAuction))
	bot.Handle("/bid", b.muteCheck(b.handleBid))
	bot.Handle("/guess", b.muteCheck(b.handleGuess))
	bot.Handle("/rob", b.muteCheck(b.handleRob))
	bot.Handle("/wordle", b.muteCheck(b.handleWordle))
	bot.Handle("/card", b.muteCheck(b.handleCardInfo))
	bot.Handle("/dart", b.muteCheck(b.handleDart))
	bot.Handle("/war", b.muteCheck(b.handleWar))
	bot.Handle("/casino_stats", b.muteCheck(b.handleCasinoStats))
