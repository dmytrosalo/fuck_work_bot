...
async def generate_riddles_with_gemini():
    ...
    prompt = """Згенеруй по 40 унікальних питань для вікторини українською мовою.
...
ВАЖЛИВО: Рівні мають бути РЕАЛЬНО складнішими!
1 (Easy): Дитячі загадки, базова математика (2+2), найпростіші факти.
2 (Medium): Шкільна програма, географія, відомі фільми. Вже треба подумати.
3 (Hard): Історія, література, фізика. Питання, які знають 50% людей.
4 (Expert): Складні наукові факти, маловідома історія, мистецтво. Знають 10% людей.
5 (Genius): Питання для "Що? Де? Коли?". Дуже вузькі знання, рідкісні факти.

Вимоги:
- Відповіді короткі (1-2 слова), в нижньому регістрі.
- Теми: кіно, музика, ігри, історія, географія, наука, спорт.
- КАТЕГОРИЧНО НЕ ПИШИ про IT, роботу, офіс.
- КАТЕГОРИЧНО НЕ ПИШИ про росію, російську мову, російську культуру і все що з цим пов'язано.
- Уникай питань, де відповідь змінюється (наприклад "хто президент")."""
...
RIDDLES_BY_LEVEL = {
    1: [  # Easy - прості факти
        ...
        {"q": "З чого роблять родзинки?", "a": ["виноград"]},
        {"q": "Скільки ніг у павука?", "a": ["8"]},
        {"q": "Що більше: слон чи кит?", "a": ["кит"]},
        {"q": "Який колір трави?", "a": ["зелений"]},
        {"q": "Скільки днів у тижні?", "a": ["7", "сім"]},
        {"q": "Хто нявкає?", "a": ["кіт", "кішка", "котик"]},
        {"q": "Скільки пальців на одній руці?", "a": ["5", "п'ять"]},
        {"q": "Яка пора року йде після зими?", "a": ["весна"]},
        {"q": "Що тече в річках?", "a": ["вода"]},
        {"q": "Який фрукт є символом Нью-Йорка?", "a": ["яблуко"]},
        {"q": "Скільки коліс у машини (зазвичай)?", "a": ["4", "чотири"]},
        {"q": "Хто зніс курочці рябі яєчко?", "a": ["курочка", "курка"]},
        {"q": "Який колір неба вдень?", "a": ["блакитний", "синій"]},
        {"q": "Що нас гріє вдень?", "a": ["сонце"]},
        {"q": "Скільки букв в алфавіті (українському)?", "a": ["33"]},
        {"q": "Хто живе у вулик?", "a": ["бджоли", "бджола"]},
        {"q": "Який місяць найкоротший?", "a": ["лютий"]},
        {"q": "Що падає з неба взимку?", "a": ["сніг"]},
    ],
    2: [  # Medium - шкільна програма
        {"q": "Столиця Франції?", "a": ["париж", "paris"]},
        {"q": "Найбільший океан?", "a": ["тихий"]},
        {"q": "Хто написав 'Кобзар'?", "a": ["шевченко"]},
        {"q": "Скільки континентів на Землі?", "a": ["6", "7", "шість", "сім"]}, # Depends on model
        {"q": "Формула води?", "a": ["h2o"]},
        {"q": "Найшвидша тварина на суші?", "a": ["гепард"]},
        {"q": "В якому році Україна стала незалежною?", "a": ["1991"]},
        {"q": "На якому материку знаходиться Бразилія?", "a": ["південна америка", "америка"]},
        {"q": "Який газ ми вдихаємо?", "a": ["кисень", "оксиген"]},
        {"q": "Скільки кутів у трикутнику?", "a": ["3", "три"]},
        {"q": "Столиця Італії?", "a": ["рим", "rome"]},
        {"q": "Хто такий Гаррі Поттер?", "a": ["чарівник", "маг"]},
        {"q": "Яка валюта в США?", "a": ["долар"]},
        {"q": "Скільки ніг у мухи?", "a": ["6", "шість"]},
        {"q": "Найвища гора світу?", "a": ["еверест", "джомолунгма"]},
        {"q": "Що вимірюють градусником?", "a": ["температуру"]},
        {"q": "Столиця Німеччини?", "a": ["берлін", "berlin"]},
        {"q": "Хто співав 'Bohemian Rhapsody'?", "a": ["queen", "квін"]},
        {"q": "Яка тварина має найдовшу шию?", "a": ["жирафа", "жираф"]},
        {"q": "Планета з кільцями?", "a": ["сатурн"]},
    ],
    3: [  # Hard - загальні знання, історія
        {"q": "В якому році почалася Друга світова війна?", "a": ["1939"]},
        {"q": "Найдовша річка в світі (за сучасними даними)?", "a": ["амазонка", "ніл"]},
        {"q": "Хто винайшов радіо (офіційно)?", "a": ["марконі", "тесла", "попов"]},
        {"q": "Столиця Австралії?", "a": ["канберра"]},
        {"q": "Символ золота в хімії?", "a": ["au"]},
        {"q": "Хто намалював 'Зоряну ніч'?", "a": ["ван гог"]},
        {"q": "Скільки зубів у дорослої людини?", "a": ["32"]},
        {"q": "Яка країна має форму чобота?", "a": ["італія"]},
        {"q": "Рік хрещення Русі?", "a": ["988"]},
        {"q": "Дата красавчик?", "a": ["так"]},
        {"q": "Найбільша пустеля світу?", "a": ["антарктична", "сахара"]}, # Technically Antarctic
        {"q": "Хто написав 'Ромео і Джульєтта'?", "a": ["шекспір"]},
        {"q": "Скільки кісток у тілі дорослої людини (приблизно)?", "a": ["206"]},
        {"q": "Яка швидкість світла (км/с)?", "a": ["300000"]},
        {"q": "Хто відкрив закон всесвітнього тяжіння?", "a": ["ньютон"]},
        {"q": "Столиця Канади?", "a": ["оттава"]},
        {"q": "Найбільша планета Сонячної системи?", "a": ["юпітер"]},
        {"q": "В якому місті знаходиться Колізей?", "a": ["рим"]},
        {"q": "Хто написав гімн України (слова)?", "a": ["чубинський"]},
        {"q": "Скільки хромосом у людини?", "a": ["46", "23 пари"]},
    ],
    4: [  # Expert - складні факти
        {"q": "Рік заснування Києва (умовний)?", "a": ["482"]},
        {"q": "Хто винайшов пеніцилін?", "a": ["флемінг"]},
        {"q": "Епл топ топ?", "a": ["не факт", "ні"]},
        {"q": "Найглибша точка океану?", "a": ["маріанська западина", "маріанський жолоб"]},
        {"q": "Яка війна тривала 100 років?", "a": ["столітня"]},
        {"q": "Автор картини 'Постійність пам'яті' (м'які годинники)?", "a": ["далі", "сальвадор далі"]},
        {"q": "Найменша пташка в світі?", "a": ["колібрі"]},
        {"q": "Хто був першим президентом США?", "a": ["вашингтон"]},
        {"q": "Який метал рідкий при кімнатній температурі?", "a": ["ртуть"]},
        {"q": "Столиця Бразилії?", "a": ["бразиліа"]},
        {"q": "Хто написав 'Майстер і Маргарита'?", "a": ["булгаков"]},
        {"q": "В якому році впав Берлінський мур?", "a": ["1989"]},
        {"q": "Найтвердіший мінерал?", "a": ["алмаз"]},
        {"q": "Яка країна подарувала США Статую Свободи?", "a": ["франція"]},
        {"q": "Як звали коня Олександра Македонського?", "a": ["буцефал"]},
        {"q": "Скільки струн у скрипки?", "a": ["4"]},
        {"q": "Хто відкрив Америку (для європейців)?", "a": ["колумб"]},
        {"q": "Найбільше озеро в світі (за площею)?", "a": ["каспійське", "каспійське море"]},
        {"q": "Хто написав 'Енеїду'?", "a": ["котляревський"]},
        {"q": "В якому році затонув Титанік?", "a": ["1912"]},
        {"q": "Столиця Туреччини?", "a": ["анкара"]},
    ],
    5: [  # Genius - дуже складні
        {"q": "Хто написав 'Божественну комедію'?", "a": ["данте", "аліг'єрі"]},
        {"q": "Яка річка двічі перетинає екватор?", "a": ["конго"]},
        {"q": "Хто винайшов динаміт?", "a": ["нобель"]},
        {"q": "Столиця Нової Зеландії?", "a": ["веллінгтон"]},
        {"q": "Як називається страх числа 13?", "a": ["трискайдекафобія"]},
        {"q": "В якому році скасували кріпацтво в Австрійській імперії (Галичина)?", "a": ["1848"]},
        {"q": "Хто був першим космонавтом незалежної України?", "a": ["каденюк"]},
        {"q": "Яка єдина країна межує з Португалією?", "a": ["іспанія"]},
        {"q": "Яка температура абсолютного нуля (-273.?)?", "a": ["15", "15 градусів"]},
        {"q": "Що означає 'terra incognita'?", "a": ["невідома земля"]},
        {"q": "Хто написав музику до балету 'Лускунчик'?", "a": ["чайковський"]},
        {"q": "Скільки клавіш у класичного фортепіано?", "a": ["88"]},
        {"q": "Який елемент 79 у таблиці Менделєєва?", "a": ["золото", "au"]},
        {"q": "Хто така Мата Харі?", "a": ["шпигунка", "танцівниця"]},
        {"q": "В якій країні народився Адольф Гітлер?", "a": ["австрія"]},
        {"q": "Яка найменша країна в світі?", "a": ["ватикан"]},
        {"q": "Перша жінка-лауреат Нобелівської премії?", "a": ["кюрі", "марія кюрі"]},
        {"q": "Рік заснування Львова?", "a": ["1256"]},
        {"q": "Що вивчає наука 'мікологія'?", "a": ["гриби"]}
    ],
}
...
async def generate_startup_idea_with_gemini() -> str:
    ...
    prompt = """Згенеруй одну СЕРЙОЗНУ, інноваційну та бізнес-орієнтовану ідею для стартапу українською мовою.
Це має бути реальна ідея, яку можна втілити в життя і яка вирішує актуальну проблему.
Формат: "Назва ідеї - Опис проблеми та рішення."
Фокус на технології, сервіси, екологію або покращення життя.
Без жартів. Без вступу, тільки сама ідея."""
